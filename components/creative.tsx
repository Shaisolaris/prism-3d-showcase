              ...
              <button className="flex w-full items-center justify-between rounded-2xl px-3 py-2 text-sm font-medium hover:bg-muted">
                <div className="flex items-center gap-3">
                  <Avatar className="h-6 w-6">
                    <AvatarImage src="/prism-3d-showcase/placeholder.svg?height=32&width=32" alt="User" />
          ...
          <div className="flex flex-1 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Avatar className="h-9 w-9 border-2 border-primary">
                <AvatarImage src="/prism-3d-showcase/placeholder.svg?height=40&width=40" alt="User" />
                <AvatarFallback>JD</AvatarFallback>
              </Avatar>
            </div>
          </div>
                ...
                <TabsContent value="home" className="space-y-8 mt-0">
                      ...
                      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div className="space-y-4">
                          ...
                          <div className="flex flex-wrap gap-3">
                            <Button className="rounded-2xl bg-white text-indigo-700 hover:bg-white/90" onClick={() => toast("Opening plans...")}>
                              Explore Plans
                            </Button>
                            <Button
                              variant="outline"
                              className="rounded-2xl bg-transparent border-white text-white hover:bg-white/10"
                             onClick={() => toast("Starting tour...")}>
                              Take a Tour
                            </Button>
                          </div>
                        </div>
                  ...
                  <section className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="ghost" className="rounded-2xl" onClick={() => toast("Loading all items...")}>
                        View All
                      </Button>
                    </div>
                        ...
                        <motion.div key={post.title} whileHover={{ scale: 1.02, y: -5 }} whileTap={{ scale: 0.98 }}>
                          <Card className="overflow-hidden rounded-3xl">
                            <div className="aspect-[4/3] overflow-hidden bg-muted">
                              <img
                                src={post.image || "/prism-3d-showcase/placeholder.svg"}
                                alt={post.title}
